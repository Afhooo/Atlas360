    ...
    return (
      <div className="rounded-2xl border border-emerald-500/40 bg-emerald-500/10 px-6 py-8 text-white shadow-lg">
        ...
        <p className="text-white/75 text-sm leading-relaxed">
          Tu opinión nos ayuda a mejorar cada entrega. El equipo de Fenix revisará tu feedback.
        </p>
      </div>
    );
  }
    ...
    <form onSubmit={handleSubmit} className="space-y-8 text-white">
      <div className="rounded-2xl border border-white/10 bg-white/5 p-6 shadow-lg">
        ...
        <p className="text-white/70 text-sm mt-2">
          Solo te tomará un minuto. Las respuestas nos ayudan a mejorar la experiencia para ti y toda la comunidad Fenix.
        </p>
      </div>
